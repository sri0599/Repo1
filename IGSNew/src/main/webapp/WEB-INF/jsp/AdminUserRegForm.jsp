	...
	<div class="container body">
		<div class="main_container">
								...
								<form:form class="form-horizontal form-label-left input_mask" 
									...
									enctype="multipart/form-data"	  
										...
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-6 col-xs-12">Initial<span class="required">*</span></label>
											<div
												class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
												<select name="title" id="title" class="form-control" onChange="javascript: if(this.selectedIndex==0||this.selectedIndex==6) { document.getElementById('sex').options[0].selected=true} if(this.selectedIndex==1||this.selectedIndex==2) { document.getElementById('sex').options[1].selected=true} if(this.selectedIndex==10){ document.getElementById('title_other').readOnly=false;  document.getElementById('title_other').focus(); } else{document.getElementById('title_other').value='';document.getElementById('title_other').readOnly=true}" onBlur="javascript: if(this.value=='Mr.'||this.value=='Shri') {document.getElementById('sex').options[0].selected=true}">
										...
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-6 col-xs-12">First Name<span class="required">*</span></label>
											<div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
												<input type="text" id="fname" name="fname" class="form-control" placeholder="First Name" required>
											</div>
											<label class="control-label col-md-3 col-sm-6 col-xs-12">Middle Name</label>
											<div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
										...
										<div class="form-group">
											...
											<div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
												<input type="text" id="old_user_id" name="old_user_id" class="form-control" placeholder="IGS Member Code" required>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
												<input type="text" id="contact_add1" name="contact_add1" class="form-control" placeholder="Correspondence Address" required>
											</div>
											<label class="control-label col-md-3 col-sm-6 col-xs-12">Permanent Address<span class="required">*</span></label>
											<div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
												<input type="text" id="add1" name="add1" class="form-control" placeholder="Permanent Address" required>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
												<input type="text" id="pin" name="pin" class="form-control" placeholder="Pin Code" required>
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-6 col-xs-12">Land Line No</label>
											<div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
												<input type="text" id="contact_no" name="contact_no" class="form-control" placeholder="Landline No" required>
											</div>
											...
											<div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
												<input type="text" id="fax" name="fax" class="form-control" placeholder="FaxNo" required>
											</div>
											<label class="control-label col-md-3 col-sm-6 col-xs-12">Email Id.</label>
											<div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
												<input type="text" id="email" name="email" class="form-control" placeholder="FaxNo" required>
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-6 col-xs-12">Designation</label>
											<div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
												<input type="text" id="desg" name="desg" class="form-control" placeholder="Designation" required>
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-6 col-xs-12">Organization</label>
											<div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
												<input type="text" id="origin" name="origin" class="form-control" placeholder="Organization" required>
											</div>
										...
										<div class="form-group">
											...
											<div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
												<input type="text" id="through" name="through" class="form-control" placeholder="Supporting Member 1(Id)" required>
											</div>
											<div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
										...
										<div class="form-group">
											...
											<div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
												<input type="text" id="through2" name="through2" class="form-control" placeholder="Supporting Member 2(Id)" required>
											</div>
											<div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
												<input type="button" id="find1" name="find1" value="Find" class="btn btn-primar" onClick="window.open('supporter_find.jsp?thru=through','popUpWindow','height=500,width=800,left=10,top=10,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no,status=yes')" placeholder="Nationality" required>
											</div>
										...
										<div class="form-group">
											...
											<div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
												<input type="text" id="mem2011" name="mem2011" class="form-control" placeholder="Membership Subscription" required>
											</div>
											<label class="control-label col-md-3 col-sm-6 col-xs-12">Journal Subscription (Annual)</label>
											<div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
												<input type="text" id="jou2011" name="jou2011" class="form-control" placeholder="Journal Subscription" required>
											</div>
										</div>
            ...
            <option value="N" selected="selected">No</option>
											...
											<div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
											 <select name="issmge1013" class="form-control" id="issmge1013"   onChange="if(this.value=='Y'){document.getElementById('issmge1013_div').style.display = 'block'} else document.getElementById('issmge1013_div').style.display = 'none'">
...
<select name="enrlyear" class="form-control" id="enrlyear">
            ...
            <option value="2025">2025</option>
										...
										<div class="form-group">
											...
											<div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
												<input type="file" id="attachment1" name="attachment1" class="form-control" placeholder="Paid Receipt Scan Copy" required>
											</div>
											<label class="control-label col-md-3 col-sm-6 col-xs-12">Other's Paid</label>
											<div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
												<input type="file" id="attachment2" name="attachment2" class="form-control" placeholder="Other's Paid" required>
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-6 col-xs-12">Self Picture</label>
											<div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
												<input type="file" id="attachment3" name="attachment3" class="form-control" placeholder="Self Picture" required>
											</div>
										
											<label class="control-label col-md-3 col-sm-6 col-xs-12">Supporting Member1 Signature,Mob. Email Pix(*.jpg,*.jpeg,*.gif,*.png)</label>
											<div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
												<input type="file" id="supp1Pic" name="supp1Pic" class="form-control" placeholder="Supporting Member1 Signature" required>
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-6 col-xs-12">Supporting Member2 Signature,Mob. Email Pix(*.jpg,*.jpeg,*.gif,*.png)</label>
											<div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
												<input type="file" id="supp2Pic" name="supp2Pic" class="form-control" placeholder="Supporting Member2 Signature" required>
											</div>
										
											<label class="control-label col-md-3 col-sm-6 col-xs-12">DOB Proof (*.jpg,*.jpeg,*.gif,*.png)</label>
											<div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
												<input type="file" id="dobPic" name="dobPic" class="form-control" placeholder="DOB Proof" required>
											</div>
										</div>										
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-6 col-xs-12">Higher Educational Document(*.jpg,*.jpeg,*.gif,*.png, *.pdf,*.doc,*.docx)</label>
											<div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
												<input type="file" id="otherPic" name="otherPic" class="form-control" placeholder="Higher Educational Document" required>
											</div>
										</div>
										<label class="control-label col-md-3 col-sm-6 col-xs-12"></label>
